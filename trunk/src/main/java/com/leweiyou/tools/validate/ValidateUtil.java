package com.leweiyou.tools.validate;
...
public class ValidateUtil { 
	...
	public static void notBlank(String value,String msg)throws Exception{
	...
	/** 两个不可为空的字符串是否相等*/
	public static boolean isNotNullableStringEqual(String pass1,String pass2) throws Exception{ 
		// 如果只有字符串都为NULL，返回false
		if (ValidateUtil.isBlank(pass1) || ValidateUtil.isBlank(pass2))
			throw new Exception("One or more string is nullb");
		// 判断两个字符串的内容是否相等
		if (pass1.equals(pass2))
			return true;		
		return false;				
